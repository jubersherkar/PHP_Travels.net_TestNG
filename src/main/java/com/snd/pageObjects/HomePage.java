...
public class HomePage
{
	...
	@FindBy(xpath = "//div[@class='input-items from_flights show active']//span[@role='combobox']")
	private WebElement originField;

	@FindBy(xpath = "//div[@class='input-items flights_arrival to_flights']//span[@role='combobox']")
	private WebElement destinationField;

	@FindBy(xpath = "//input[@id='departure']")
	private WebElement departureDate;

	@FindBy(xpath = "//div[@id='onereturn']//div//div//div//div//a[@role='button']")
	...
	@FindBy(xpath = "//ul[normalize-space()='All Rights Reserved by PHPTRAVELS']")
	...
	@FindBy(xpath = "//span[@class='j_listABTit']")
	private WebElement flightsFoundLabel;
	...
	public WebElement getFlightsFoundLabel()
	{
		wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.visibilityOf(flightsFoundLabel));
		return flightsFoundLabel;
	}
